    ...
    describe ("numberListFormatter", function() {
        describe("when all label are lower than 1000", function() {
            it("should format all labels as units", function() {
                var formatter = GOVUK.Insights.numberListFormatter([0, 50, 100, 150]);
        ...
        describe("when all label are lower than 1,000,000", function() {
            it("should format all labels as thousands", function() {
                var formatter = GOVUK.Insights.numberListFormatter([0, 1000, 2000, 3000]);
                expect(formatter(2000)).toBe("2k");
            });

            it("should format with decimals if any label requires it", function() {
                var formatter = GOVUK.Insights.numberListFormatter([0, 500, 1000, 1500]);
        ...
        describe("when labels go over 1,000,000", function() {
            it("should format all labels as million", function() {
                var formatter = GOVUK.Insights.numberListFormatter([0, 1000000, 2000000, 3000000]);
                expect(formatter(2000000)).toBe("2m");
            });

            it("should format with decimals if any label requires it", function() {
                var formatter = GOVUK.Insights.numberListFormatter([0, 500000, 1000000, 1500000]);
        ...
        describe("when applied to zero", function() {
            it("should always format zero as '0'", function() {
                expect((GOVUK.Insights.numberListFormatter([0,      50,     100]))(0)).toEqual("0");
                expect((GOVUK.Insights.numberListFormatter([0,     500,    1000]))(0)).toEqual("0");
                expect((GOVUK.Insights.numberListFormatter([0,    1000,    2000]))(0)).toEqual("0");
                expect((GOVUK.Insights.numberListFormatter([0,  500000, 1000000]))(0)).toEqual("0");
                expect((GOVUK.Insights.numberListFormatter([0, 1000000, 2000000]))(0)).toEqual("0");
            });
        });
