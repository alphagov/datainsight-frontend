...
GOVUK.Insights.formatSuccessInsidegov = function () {
    GOVUK.Insights.formats = {
        news: {
            ...
            taglineGraph: 'News items updated in last 2 months; items with fewer than 1000 views not shown',
            taglineTable: 'News items updated in last 2 months; data not available for items with fewer than 1000 views'
        },
        detailed_guidance: {
