$.ajax({
    ...
    success: function (data) {
      ...
      graph.append("svg:text")
          .text("Most visited")
          .attr("x", function() { return w - $(this).width() })
          .attr("y", h/2 + 15)
          .attr("dy", ".71em")
      ...
      graph.selectAll("circle.format")
          ...
          .attr("cy", function(d) { return y(d.percentageOfSuccess); })
      ...
      graph
          ...
          .attr("y", function(d) { return y(d.percentageOfSuccess); })
          .attr("dy", ".35em");
      ...
      panel
        ...
        .attr("fill", "none")
        .attr("stroke", "black")
        .attr("cx", function(d) { return maxCircleRadius; })
      ...
      panel
        ...
        .attr("y", function(d, index) { return 15*index + maxCircleRadius/2; })
        .attr("dy", ".35em")
        .attr("text-anchor", "end")
        .text(function (d) { return GOVUK.formatTickLabel(d, maxX) + " visits"; });
    }});
